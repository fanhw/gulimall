package fhw.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

import fhw.gulimall.member.feign.CouponFeignService;
...
import fhw.gulimall.member.service.MemberService;
...
public class MemberController {
    ...
    public R test(){
        MemberEntity memberEntity = new MemberEntity().setNickname("fhw");
